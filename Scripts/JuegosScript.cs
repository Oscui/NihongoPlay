...
public class JuegosScript : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        var uiDocument = GetComponent<UIDocument>();
            ...
            btnJugar1 = root.Q<Button>("btnjugar1");
            btnJugar2 = root.Q<Button>("btnjugar2");
            ...
            btnJugar1.RegisterCallback<ClickEvent>(ev => OnJugar1Click());
            btnJugar2.RegisterCallback<ClickEvent>(ev => OnJugar2Click());
    ...
    void OnJugar1Click()
    {
        Debug.Log("Botón Jugar 1 pulsado");
    ...
    void OnJugar2Click()
    {
        Debug.Log("Botón Jugar 2 pulsado");
        SceneManager.LoadScene("Tatami TilesMenu");
    }
}
